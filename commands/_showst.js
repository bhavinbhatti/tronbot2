...
var g="<b>🌱Total Deposits:</b> \n"+bal.value().toFixed(8)+" "+cur+" \n\n<b>🔄 Total Reinvestments:</b> "+re.value().toFixed(8)+" "+cur+"\n\n<b>💳 Total Withdrawals:</b> \n"+ba.value().toFixed(8)+" "+cur
 let ref_1= Libs.ResourcesLib.anotherUserRes("total_refferral_earning_1", "1021837737");
let ref_2= Libs.ResourcesLib.anotherUserRes("total_refferral_earning_2", "1021837737");
let ref_3= Libs.ResourcesLib.anotherUserRes("total_refferral_earning_3", "1021837737");
let ref= Libs.ResourcesLib.anotherUserRes("total_refferral_earning", "1021837737");
let resp2= Libs.ResourcesLib.anotherUserRes("active_investor", "1021837737");
let resp21= Libs.ResourcesLib.anotherUserRes("active_investor_amount", "1021837737");
let resp3= Libs.ResourcesLib.anotherUserRes("active_investor_investment", "1021837737");
let total_count = Libs.ResourcesLib.anotherUserRes("user_position", 1021837737);

...
Bot.run( {
    command:'/adc'+' '+peh1+' '+relg75.value()+' '+amount+' '+options.currency+' '+'dep1',
...
Bot.run( {
    command:'/adc'+' '+peh2+' '+relg75.value()+' '+amount+' '+options.currency+' '+'dep2',
...
Bot.run( {
    command:'/adc'+' '+peh3+' '+relg75.value()+' '+amount+' '+options.currency+' '+'dep3',
